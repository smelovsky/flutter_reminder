...
class _$ResultsImpl implements _Results {
  ...
  @override
  String toString() {
    return 'Results(name: $name, email: $email, picture: $picture)';
  }
...
class _$UserResponseImpl implements _UserResponse {
  const _$UserResponseImpl({required this.results});
...
abstract class _UserResponse implements UserResponse {
  const factory _UserResponse({required final Results results}) =
      _$UserResponseImpl;
