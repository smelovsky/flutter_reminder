...
import 'package:flutter_reminder/theme/app_theme.dart';
import 'package:flutter_reminder/ui/core/bloc_observer.dart';
import 'package:flutter_reminder/ui/preview_page.dart';
...
const MethodChannel platform = MethodChannel('com.example/flutter_reminder');
...
Future<void> main() async {
  ...
  String initialRoute = ReminderApp.routeName;
  if (notificationAppLaunchDetails?.didNotificationLaunchApp ?? false) {
    selectedNotificationPayload =
        notificationAppLaunchDetails!.notificationResponse?.payload;
    initialRoute = PreviewPage.routeName;
  }
      ...
      builder: (_, isLight, __) => MultiBlocProvider(
            ...
            child: MaterialApp(
              ...
              routes: <String, WidgetBuilder>{
                '/': (_) => ReminderApp(notificationAppLaunchDetails),
                '/previewPage': (_) => PreviewPage(selectedNotificationPayload)
              },
            ),
          )));
}
